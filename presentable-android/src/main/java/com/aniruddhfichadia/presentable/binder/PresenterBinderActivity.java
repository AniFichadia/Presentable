...
public class PresenterBinderActivity<
    ...
    public static class BindingLifecycleCallbacks<
        ...
        private boolean guaranteeBinding(Activity activity) {
            ActivityT boundedActivity = boundReference.get();

            if (boundedActivity != null && boundedActivity == activity) {
                return true;
            } else if (boundedActivity == null) {
