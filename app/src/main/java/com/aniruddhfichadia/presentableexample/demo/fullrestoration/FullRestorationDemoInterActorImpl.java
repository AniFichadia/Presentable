 ...
 * @date 2017-03-02
 */
public class FullRestorationDemoInterActorImpl
        extends BaseInterActor
        implements FullRestorationDemoInterActor {
    private FullRestorationDemoInterActorListener listener;
    private AtomicBoolean doingAsyncStuff = new AtomicBoolean(false);


    public FullRestorationDemoInterActorImpl(@NotNull Executor executor) {
        super(executor);
    }


    @Override
    public void setListener(FullRestorationDemoInterActorListener listener) {
